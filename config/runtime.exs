...
#
#     PHX_SERVER=true bin/kakemono start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :kakemono, KakemonoWeb.Endpoint, server: true
end

if api_secret = System.get_env("KAKEMONO_API_SECRET") do
  config :kakemono, :api_secret, api_secret
end

data_dir =
  System.get_env("KAKEMONO_DATA_DIR") ||
    if config_env() == :prod, do: "/data"

data_dir = if data_dir, do: Path.expand(data_dir)
...
if config_env() == :prod do
  ...
  #
  #     config :kakemono, Kakemono.Mailer,
