...
function previewSkyState(tod) {
  switch (tod) {
    case "day":
      return {
        tod,
        isDay: "1",
        sun: { x: 0.58, y: 0.72, visible: 1 },
        moon: { x: 0.24, y: 0.56, visible: 0 },
        twilight: 0,
        night: 0,
        stars: 0,
      };
    case "dawn":
      return {
        tod,
        isDay: "1",
        sun: { x: 0.18, y: 0.18, visible: 1 },
        moon: { x: 0.72, y: 0.24, visible: 0 },
        twilight: 0.92,
        night: 0.12,
        stars: 0,
      };
    case "dusk":
      return {
        tod,
        isDay: "1",
        sun: { x: 0.82, y: 0.14, visible: 1 },
        moon: { x: 0.26, y: 0.24, visible: 0 },
        twilight: 0.92,
        night: 0.32,
        stars: 0,
      };
    case "night":
      return {
        tod,
        isDay: "0",
        sun: { x: 0.72, y: 0.08, visible: 0 },
        moon: { x: 0.30, y: 0.76, visible: 1 },
        twilight: 0,
        night: 1,
        stars: 0.82,
      };
...
const WeatherSky = {
  ...
  render() {
    const el = this.el;
    const preview = previewSkyState(el.dataset.previewTod);
    ...
    if (preview) {
      ...
      if (el.getAttribute("data-tod") !== preview.tod) {
        el.setAttribute("data-tod", preview.tod);
      }
      if (el.getAttribute("data-is-day") !== preview.isDay) {
        el.setAttribute("data-is-day", preview.isDay);
      }
      this.lastTod = preview.tod;
      return;
    }
