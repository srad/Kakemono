    ...
    <div class="space-y-6">
      <div class="flex flex-col gap-1 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <h1 class="text-2xl font-semibold tracking-tight text-slate-950">Media Library</h1>
        </div>
        <p class="text-sm text-slate-500">{@item_count} items</p>
      </div>
      ...
      >
        <div class="mb-4 flex flex-col gap-1">
          ...
          <p class="text-sm text-slate-500">
            Images and videos are added to the library and processed in the background.
          </p>
        </div>
        <.live_file_input
